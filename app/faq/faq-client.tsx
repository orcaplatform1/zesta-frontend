  ...
  },
  {
    ...
    a: (
      <>
        ...
        <Link href="/legal/mesafeli-satis-sozlesmesi" className="text-champagne-300 hover:text-champagne-200 underline">
  ...
  },
  {
    ...
    a: (
      <>
        ...
        <Link href="/about" className="text-champagne-300 hover:text-champagne-200 underline">
          Hakkımızda
        </Link>{" "}
  ...
  },
  {
    ...
    a: (
      <>
        ...
        <Link href="/contact" className="text-champagne-300 hover:text-champagne-200 underline">
          İletişim
        </Link>{" "}
