    ...
    <div className="mx-auto max-w-md px-5 py-24">
      ...
      <div className="mt-12 border-t border-[var(--border-subtle)] pt-8">
        ...
        <form onSubmit={changePassword} className="space-y-3">
          <PasswordField placeholder="Mevcut şifre" required value={currentPassword} onChange={setCurrentPassword} />
          <PasswordField
      ...
      <div className="mt-12 flex flex-col gap-3 border-t border-[var(--border-subtle)] pt-8">
        <Link href="/hesap/siparislerim" className="text-sm text-champagne-300 underline">
          Siparişlerim
        </Link>
